  ...
  <div id="wrapper">
    <div id="container">
      <div id="content1" style="margin-left: 230px; margin-top: 130px;">
          ...
          <button type="button" onclick="window.location.href='tambahAccountPetugas.php'" class="btn shadow-sm p-2 bg-success rounded" id="button" style="margin-top: 10px;">Tambah Account User</button><br><br>
