      ...
      $.ajax({
          ...
          var content = "";
            for (let index = 0; index < data.length; index++) {
              ...
              '<td><button id="row_clicked" value="' + (element.id_kritiksaran - 1) + '"' + 'type="button" class="btn btn-primary" data-toggle="modal" data-target="#contohModalScroll">VIEW</button></td>' 
            ...
            $(".btn").click(function(){
              indexrow = $("#row_clicked").val();
              dataSaran = data[indexrow].pesan_kritiksaran;
              $("#pesan").html(dataSaran);
            });
          }
        });
      }
