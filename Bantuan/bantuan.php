            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-7">
                        <blockquote>
                            <p>
                                Bantuan ini memberikan jawaban atas pertanyaan dasar tentang E-POSYANDU Melati. Lihat Bantuan Lanjutan kami untuk informasi teknis lebih lanjut.
                            </p>
                            <h4>
                                Bantuan Dasar:
                            </h4>
                            <ol>
                                ...
                                <a href="#t03"><li>Apa Kelebihan E-POSYANDU Melati dibandingkan pendataan manual</li></a>
                                <a href="#t05"><li>Apakah E-POSYANDU Melati Kompatible dengan smartphone saya?</li></a>
                            </ol>
                            <h4>
                                Bantuan Lanjutan:
                            </h4>
                            ...
                            <div>
                                <h4 id="t02">Apa Itu E-POSYANDU Melati?</h4>
                                <p>E-Posyandu Melati adalah aplikasi berbasis web yang bermanfaat sebagai perantara untuk melakukan pendataan secara praktis dan juga dapat membantu pekerjaan para kader. </p>
                            </div><hr style="height: 2px; background-color: black;">
                            <div id="t03" style="height: 300px;"></div>

                            <div id="t04">
                                <h4>Apa Kelebihan E-POSYANDU Melati dibandingkan pendataan manual</h4>
                            ...
                            <div id="t06">
                                <h4>Apakah E-POSYANDU Melati Kompatible dengan smartphone saya?</h4>
